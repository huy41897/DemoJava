...
public class Student {
    ...
    public static void ThemThongTin(List<Student> std) {
         Scanner sc = new Scanner(System.in);
    ...
    public static void HienThi(List<Student> std) {
    ...
    public static void CapNhat(List<Student> std) {
         Scanner sc = new Scanner(System.in);
         System.out.println("nhap vi tri can update :");
         int i = sc.nextInt();
         if (i >= 0 && i < std.size()) {
              Student hs = std.get(i);
              hs.NhapThongTin();
              std.set(i, hs);
              System.out.println("Success");
         } else {
    ...
    public static void Xoa(List<Student> std) {
       Scanner sc = new Scanner(System.in);
